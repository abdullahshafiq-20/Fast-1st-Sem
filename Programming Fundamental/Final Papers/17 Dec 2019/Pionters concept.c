...
int main() 
{
    ...
    printf("value of a is :%d",**r);//since double pointer r stores the address that p has and it is also being referred it prints the value stored at that address(a)/    return 0
}